...
def score_binder_complex(results, dsobj, contacts, distance_cutoffs):
    ...
    contact_list, contactscore = score_contacts_pae_weighted(results, pdb, reslist1, reslist2, contact_cap=100, dsobj=dsobj, first_only=False, dist=distance_cutoffs[0])
