...
def score_overall(results:list, dsobj, contacts=None, distance_cutoffs=None, rmsd_pdb=None):
    ...
    if rmsd_to_starting > 3.0:
        return 1000, ((1000, 1000), (1000, 1000), (1000,), (1000,), (1000,), (1000,), (1000,) ), pdbs, results
    ...
    overall_score = -complexscore2 - monomer + rmsd_symm - (dist) + penalty - bonus

    return overall_score, (confidence_tuple, monomer_tuple, (rmsd_symm,), (dist,), (penalty,), (bonus,)), pdbs, results
...
def score_complex_confidence(results, dsobj, helix_motif=None):
    ...
    return score, (confscore2, confscore1)
