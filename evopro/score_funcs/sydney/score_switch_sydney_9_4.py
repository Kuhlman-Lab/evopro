...
def score_overall(results:list, dsobj, contacts=None, distance_cutoffs=None, rmsd_pdb=None):
    ...
    if rmsd_to_starting > 3.0:
        return 1000, ((1000, 1000), (1000, 1000, 1000), (1000,), (1000,), (1000,), (1000,), (1000,), (1000,), (1000,) ), pdbs, results
    

    gyration = Rg(pdb2, chnid="A") #want a limit of 15, per Tomiris's score function
    gyration2 = Rg(pdb1, chnid="A") #want a limit of 15, per Tomiris's score function
    ...
    #format is get_hse_dim_vs_mono_score(monomer, dimer)
    ...
    overall_score = (-complexscore2/5) - monomer + rmsd_symm - rmsd_switch - (dist/10) - serine_hse_mono + (gyration) + (gyration2/2) + hse_score #negative dist to maximize score term
    ...
    return overall_score, (confidence_tuple, monomer_tuple, (rmsd_symm,), (rmsd_switch,), (dist,), (serine_hse_mono,), (gyration,), (gyration2,), (hse_score,)), pdbs, results
