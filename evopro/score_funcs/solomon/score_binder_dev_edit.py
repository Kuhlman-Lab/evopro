...
def score_overall(results, dsobj, contacts=None, distance_cutoffs=None, starting_pdb=None, binder_chain="A", contact_cap=50):
...
def score_binder_complex(results, dsobj, contacts, distance_cutoffs, binder_chain="A", contact_cap=50):
    from alphafold.common import protein
...
def score_binder_rmsd_to_starting(pdb, path_to_starting, dsobj=None, binder_chain="A"):
...
def score_rmsd_to_starting(pdb, path_to_starting="/work/users/s/o/solomono/thesis_lab/prelims/Desktop/evopro/ep/test2/templates/path_to_start", ca_only=True, dsobj=None):
