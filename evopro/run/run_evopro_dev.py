...
def run_genetic_alg(run_dir, af2_flags_file, score_func, startingseqs, poolsizes = [],
...
if __name__ == "__main__":
    ...
    run_genetic_alg(input_dir, input_dir + flagsfile, scorefunc, starting_seqs, poolsizes=pool_sizes, 
