...
def run_genetic_alg_multistate(run_dir, af2_flags_file, score_func, startingseqs, af2_flags_file_2 = None, poolsizes = [], 
                               ...
                               score_func_2=None, score_func_2_iter=30, mpnn_chains=None, rmsd_pdb=None,
    ...
    if af2_flags_file_2:
        ...
        dist2 = Distributor(n_workers, af2_init, af2_flags_file_2, lengths)
    ...
    while curr_iter <= num_iter:
        ...
        for results, dsobj in zip(results_packed, scoring_pool):
            if rmsd_pdb:
                scores.append(score_func(results, dsobj, contacts=contacts, distance_cutoffs=distance_cutoffs, starting_pdb=rmsd_pdb))
            else:
...
if __name__ == "__main__":
    ...
    if input_dir not in ['', None]:
            ...
            if flagsfile is None:
                raise ValueError("Flags file for AlphaFold2 runs not provided.")
            if resfile is None:
    ...
    run_genetic_alg_multistate(input_dir, input_dir + flagsfile, scorefunc, starting_seqs, af2_flags_file_2=flagsfile2, poolsizes=pool_sizes, 
        ...
        score_func_2=scorefunc2, score_func_2_iter=args.score_func_2_iteration, mpnn_chains=mpnn_chains, rmsd_pdb=args.path_to_starting,
