...
if __name__ == '__main__':
    pdb_path = '/work/users/s/e/sela/fall2023/dengueproj/new_evopro/11_7_diagnose/2_d1_msa_score2/outputs/seq_0_result_0.pbz2'
    with open(pdb_path,"r") as pdbf:
        pdb = pdbf.read()
        results = decompress_pickle(run_path)
        print(results)
