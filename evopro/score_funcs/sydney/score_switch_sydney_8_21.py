...
def score_overall(results:list, dsobj, contacts=None, distance_cutoffs=None, rmsd_pdb=None):
    ...
    rmsd3 = rmsd_to_original_pdb(pdb2, "original.pdb")
    ...
    if rmsd3 != 0:
        ...
        overall_score = complexscore2 + monomer + rmsd1 + rmsd2 - dist - serine_hse_mono - 1/rmsd3 #negative dist to maximize score term
    else:
        overall_score = 0 
    # return overall_score, (complexscore1, complexscore2, monomer, rmsd1, rmsd2, dist), pdbs, results
    return overall_score, (confidence_tuple, monomer_tuple, (rmsd1,), (rmsd2,), (dist,), (serine_hse_mono,), (rmsd3,)), pdbs, results
