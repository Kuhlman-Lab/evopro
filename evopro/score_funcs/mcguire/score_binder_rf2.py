...
from evopro.score_funcs.mcguire.score_funcs_efficient import score_contacts_pae_weighted_efficient
import os
import subprocess
import shutil
import math
...
def score_binder_complex(results, dsobj, contacts, distance_cutoffs):
    ...
    print(f"reslist1 = {reslist1}")
    print(f"reslist2 = {reslist2}")
