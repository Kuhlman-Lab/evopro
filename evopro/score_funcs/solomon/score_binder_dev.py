...
def score_overall(results, dsobj, contacts=None, distance_cutoffs=None, starting_pdb=None, binder_chain="A", contact_cap=36):
...
def score_binder_complex(results, dsobj, contacts, distance_cutoffs, binder_chain="A", contact_cap=36):
    from alphafold.common import protein
