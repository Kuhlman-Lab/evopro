...
def score_overall(results:list, dsobj, contacts=None, distance_cutoffs=None, rmsd_pdb=None):
    ...
    if rmsd_to_starting > 3.0:
        return 1000, ((1000,), (1000,), (1000,), (1000,), (1000,), (1000,)), pdbs, results
    ...
    overall_score = -ptm_monomer + iptm_dimer - iptm_phos_dimer + penalty - bonus

    return overall_score, ((ptm_monomer,), (iptm_dimer,), (iptm_phos_dimer,), (penalty,), (bonus,)), pdbs, results