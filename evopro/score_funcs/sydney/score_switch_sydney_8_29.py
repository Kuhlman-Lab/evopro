...
import os
from evopro.score_funcs.helper import get_helix_motif, get_weighted_solvent_exposed_return_ser_contacts, rmsd_to_original_pdb, check_serine_polar_contacts
...
def score_overall(results:list, dsobj, contacts=None, distance_cutoffs=None, rmsd_pdb=None):
    ...
    overall_score = complexscore2 - monomer + rmsd_symm - rmsd_switch - dist - serine_hse_mono + (gyration/15) + (gyration2/25) #negative dist to maximize score term
    ...
    return overall_score, (confidence_tuple, monomer_tuple, (rmsd_symm,), (rmsd_switch,), (dist,), (serine_hse_mono,), (gyration,), (gyration2,)), pdbs, results
